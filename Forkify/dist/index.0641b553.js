    ...
    <div class="recipe__main w-2/3">
          ...
          <div class="recipe__info mt-4 flex flex-row justify-around">
            <div class="cocking__time flex flex-row text-gray-900">
              ...
              <h1><span class="font-semibold">${recipe.cookingTime}</span> minutes</h1>
            </div>
            <div class="cooking__serveings flex flex-row text-gray-900">
              ...
              <h1><span class="font-semibold">${recipe.servings}</span> servings</h1>
              <button>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
          ...
          <div class="guide-to-cook flex justify-center flex-col items-center mt-9 px-6">
            ...
            <p class="guide-para">This recipe was carefully designed and tested by <span class="publisher">${recipe.publisher}</span>.
...
},{}]},["hklly","bNKaB"], "bNKaB", "parcelRequireeb27")
